...
camera.orthographicorthographic = True
camera.fov=1,5
camera.positionposition=(1,1)

player=Entity(name='O',color=color.azure)
cursor=Tooltip(color=player.color,origin=(1,1),scale=3,enabled=True)
cursor.background.color=color.clear

bg=Entity(parent=scene,model='quad',texture='shore',scale=(10),z=10,color=color.light_gray)
mouse.visible=True
